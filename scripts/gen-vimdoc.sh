#!/usr/bin/env bash
#
# Generate doc/nxvim-editorconfig.txt (the vimdoc help file) from
# doc/nxvim-editorconfig.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/nxvim-editorconfig.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="nxvim-editorconfig"                    # → :help nxvim-editorconfig
DESCRIPTION="EditorConfig support for nxvim"    # header tagline (line 1)
# -----------------------------------------------------------------------------
