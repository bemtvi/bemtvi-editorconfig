#!/usr/bin/env bash
#
# Generate doc/bemtvi-editorconfig.txt (the vimdoc help file) from
# doc/bemtvi-editorconfig.md using panvimdoc <https://github.com/kdheepak/panvimdoc>
...
# file is never hand-aligned. Edit doc/bemtvi-editorconfig.md, then run this.
#
...
# --- per-plugin settings -----------------------------------------------------
PROJECT="bemtvi-editorconfig"                    # → :help bemtvi-editorconfig
DESCRIPTION="EditorConfig support for bemtvi"    # header tagline (line 1)
# -----------------------------------------------------------------------------
